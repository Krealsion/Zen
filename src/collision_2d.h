...
private:
  ...
  /**
   * Determines if the lines have a chance to collide
   * @param l1
   * @param l2
   * @return
   */
  bool bounding_line_collision_check(Line2D l1, Line2D l2) const;
  /**
  ...
  /**
   * Gets the smallest rectangle in normal space that contains all the points
   * @param points
   * @return
   */
